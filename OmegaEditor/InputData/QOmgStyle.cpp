...
QOmgStyle::CurrentStyleSheet( )
{
    ...
    "QComboBox::down-arrow {"
        "image: url( :/OmegaEditor/Resources/Icons/down_arrow.png)"
    "}"
    ...
    "QPushButton:pressed  {"
     ...
     "QLineEdit  {"
      ...
      "QSpinBox::up-button  {"
        ...
        "image: url(:/OmegaEditor/Resources/Icons/plus_black.png);"
        "}"
        ...
        "QSpinBox::down-button  {"
          "border: 1px solid black;"
          "width: 15px; /* 16 + 2*1px border-width = 15px padding + 3px parent border */"
          "image: url(:/OmegaEditor/Resources/Icons/minus_black.png);"
