...
QOmgTreeEntities::AddPlayersToTheTree( void )
{
    ...
    //! Make the root item
    QOmgLeaf* p_item = new QOmgLeaf(this, Omega::PlayerLeaf,QString("Players"), QIcon(":/Media/character.png") );
...
{
    //! Make the root item
    QOmgLeaf* p_item = new QOmgLeaf(this, Omega::ItemLeaf,QString("Items"),QIcon(":/Media/item.png"));
