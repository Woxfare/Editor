...
void
OmgSceneObjContainer::Load(QString filename)
{
    // Harcoded objects
    std::map<std::string, std::string> textures;
    textures["Top"] = "metal_box_texture.png";
    textures["Bottom"] = "metal_box_texture.png";
    textures["Left"] = "metal_box_texture.png";
    textures["Right"] = "metal_box_texture.png";
    textures["Front"] = "metal_box_texture.png";
    textures["Back"] = "metal_box_texture.png";
    _map_obj["MetalBox"] = new OmgSceneObj("MetalBox", textures);

    textures["Top"] = "terrain_top.png";
    textures["Bottom"] = "terrain_bottom.png";
    textures["Left"] = "terrain_left.png";
    textures["Right"] = "terrain_right.png";
    textures["Front"] = "terrain_front.png";
    textures["Back"] = "terrain_back.png";
    _map_obj["Terrain"] = new OmgSceneObj("Terrain", textures);

    textures["Top"] = "wood_box_texture.png";
    textures["Bottom"] = "wood_box_texture.png";
    textures["Left"] = "wood_box_texture.png";
    textures["Right"] = "wood_box_texture.png";
    textures["Front"] = "wood_box_texture.png";
    textures["Back"] = "wood_box_texture.png";
    _map_obj["WoodBox"] = new OmgSceneObj("WoodBox", textures);
    qDebug() << "CREANDO SCENEOBJ 2";
}
