...
QOmgFolderDialog::createWidget( void )
{
    ...
    ui->listWidget->addItem( new QListWidgetItem(QIcon(":/OmegaEditor/Resources/Icons/enemy.png"), "Enemy Folder"));
    ui->listWidget->addItem( new QListWidgetItem(QIcon(":/OmegaEditor/Resources/Icons/character.png"), "Player Folder"));
    ui->listWidget->addItem( new QListWidgetItem(QIcon(":/OmegaEditor/Resources/Icons/sceneobj.png"), "Scene Object Folder"));
    ui->listWidget->addItem( new QListWidgetItem(QIcon(":/OmegaEditor/Resources/Icons/item.png"), "Item Folder"));
    ui->listWidget->addItem( new QListWidgetItem(QIcon(":/OmegaEditor/Resources/Icons/gun.png"), "Weapon Folder"));
    ui->listWidget->addItem( new QListWidgetItem(QIcon(":/OmegaEditor/Resources/Icons/map.png"), "Map Folder"));
    ui->listWidget->addItem( new QListWidgetItem(QIcon(":/OmegaEditor/Resources/Icons/game.png"), "Game Folder"));
}
