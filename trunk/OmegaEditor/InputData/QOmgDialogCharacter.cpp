...
QOmgDialogCharacter::ChangeWidgetsForEnemy()
{
  ...
  ui->_pb_textures->setIcon( QIcon(":/OmegaEditor/Resources/Icons/enemy.png") );
  ...
  for(; it != it_end; ++it)
  {
      ...
      ui->listWidget->addItem(new QListWidgetItem(QIcon(":/OmegaEditor/Resources/Icons/folder.png"), p_folder->getName()));
  }
...
QOmgDialogCharacter::ChangeWidgetsForPlayer()
{
    ...
    for(; itWeapons != itEndWeapons ; ++itWeapons )
    {
      ...
      if( weapon )
        ui->weaponList->addItem(new QListWidgetItem(QIcon(":/OmegaEditor/Resources/Icons/gun.png"), weapon->getName()));
    }
