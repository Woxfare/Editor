...
#include "InputData/QOmgListWidgetItem.h"
...
QOmgExporterDialog::fillListOfEntities( void )
{
    ...
    for(; it != itEnd ;++it)
    {
        ...
        if(!pPlayer)
            continue;
        QOmgListWidgetItem* pItem = new QOmgListWidgetItem(QIcon(":/OmegaEditor/Resources/Icons/character.png"), pPlayer->getName(), Omega::Player);
    ...
    for(; it != itEnd ;++it)
    {
        ...
        if(!pEnemy)
            continue;
        QOmgListWidgetItem* pItem = new QOmgListWidgetItem(QIcon(":/OmegaEditor/Resources/Icons/enemy.png"), pEnemy->getName(), Omega::Enemy);
    ...
    for(; it != itEnd ;++it)
    {
        ...
        if(!pOmgItem)
            continue;
        QOmgListWidgetItem* pItem = new QOmgListWidgetItem(QIcon(":/OmegaEditor/Resources/Icons/item.png"), pOmgItem->getName(), Omega::Item);
    ...
    for(; it != itEnd ;++it)
    {
        ...
        if(!pSceneObj)
            continue;
        QOmgListWidgetItem* pItem = new QOmgListWidgetItem(QIcon(":/OmegaEditor/Resources/Icons/sceneobj.png"), pSceneObj->getName(), Omega::SceneObj);
