...
OmgSceneObj::OmgSceneObj(QString a_name ) : OmgEntity ( a_name )
{
    setType(Omega::SceneObj);
    setPixmap(QPixmap(":/OmegaEditor/Resources/Icons/sceneobj.png"));
...
OmgSceneObj::OmgSceneObj( QString a_name, std::map<std::string, std::string> a_textures ) : OmgEntity ( a_name )
{
    setType(Omega::SceneObj);
    setPixmap(QPixmap(":/OmegaEditor/Resources/Icons/sceneobj.png"));
    _folder = QString("DefaultObjects" );
...
OmgSceneObj::OmgSceneObj(QString a_name, std::map<std::string, std::string> a_textures, int rgb[3]) : OmgEntity ( a_name )
{
    setType(Omega::SceneObj);
    setPixmap(QPixmap(":/OmegaEditor/Resources/Icons/sceneobj.png"));
    _folder = QString("DefaultObjects" );
